defmodule HelloScenicFull.Component.Nav do
  ...
  def init(scene, current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", HelloScenicFull.Scene.Sensor},
           {"Sensor (spec)", HelloScenicFull.Scene.SensorSpec},
           {"Primitives", HelloScenicFull.Scene.Primitives},
           {"Fills", HelloScenicFull.Scene.Fills},
           {"Strokes", HelloScenicFull.Scene.Strokes},
           {"Components", HelloScenicFull.Scene.Components},
           {"Transforms", HelloScenicFull.Scene.Transforms},
           {"Sprites", HelloScenicFull.Scene.Sprites}
         ], current_scene},
        id: :nav,
        translate: {90, 10}
      )
